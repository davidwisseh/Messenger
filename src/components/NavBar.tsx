            ...
            <div className=" ml-auto">
              <div className={"flex gap-2 items-center "}>
                <div
                  ...
                  className=" sm:mx-0 w-10 sm:w-full pr-2  h-full    flex justify-start items-center  active:scale-90 sm:place-self-start hover:scale-110 transform duration-300  brightness-125 rounded-full dark:text-yellow-700"
                >
                  <div className="w-6 mt-auto  block h-6 sm:w-9 sm:h-9">
                    <svg
